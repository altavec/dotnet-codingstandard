namespace Altavec.DotNet.CodingStandard.Tests;
                ...
                <configuration>
                  ...
                  <packageSourceMapping>
                    ...
                    <packageSource key="TestSource">
                        <package pattern="Altavec.DotNet.CodingStandard" />
                    </packageSource>
                  </packageSourceMapping>
                </configuration>
                """);
        ...
        public ProjectBuilder AddCsprojFile((string Name, string Value)[]? properties = null, (string Name, string Version)[]? nuGetPackages = null, XElement[]? additionalProjectElements = null)
        {
            ...
            string content = $"""
                <Project Sdk="Microsoft.NET.Sdk">
                  ...
                  {packagesElement}
                  <ItemGroup>
                    <PackageReference Include="Altavec.DotNet.CodingStandard" Version="999.9.9" />
                  </ItemGroup>
